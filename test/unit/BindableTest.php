...
//		$todoListElement->bindList($todoData);
//
...
//	}
//
//	public function testBindListTemplatesCleanedUpAfterAdding() {
//		$document = new HTMLDocument(Helper::HTML_TODO_LIST);
//		$todoData = [
//			["id" => 1, "title" => "Write tests", "complete" => true],
//			["id" => 2, "title" => "Implement features", "complete" => false],
...
//	}
//
//	public function testBindListWithInlineNamedTemplate() {
...
//	public function testBindListWithInlineNamedTemplateWhenAnotherTemplateExists() {
